...
def process_form(request):
    ...
    if form_data['image_id']:
        ...
        def process_im(image_path):
            ...
            output_path = 'D:/my back/69/Hossamf/Hossam/model/processed/processed_image.png'
            cv2.imwrite(output_path, processed_image_bgr)
            return output_path

        folder_path = r'D:/my back/69/Hossamf/Hossam/media/modelphoto'
        ...
        if os.path.isfile(image_path):
            ...
            model_path = r'D:/my back/69/Hossamf/Hossam/model/hossam.keras'
            ...
            file_path = "D:/my back/69/Hossamf/output.txt"
